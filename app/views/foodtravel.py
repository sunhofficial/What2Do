...
resName = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(4) > div.head_item.clickArea > strong > a.link_name").text
reviewNum = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(4) > div.rating.clickArea > a > em").text
rate = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(4) > div.rating.clickArea > span.score > em").text
address = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(4) > div.info_item > div.addr > p:nth-child(1)").text
...
resName = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(5) > div.head_item.clickArea > strong > a.link_name").text
reviewNum = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(5) > div.rating.clickArea > a > em").text
rate = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(5) > div.rating.clickArea > span.score > em").text
address = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(5) > div.info_item > div.addr > p:nth-child(1)").text
...
resName = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(6) > div.head_item.clickArea > strong > a.link_name").text
reviewNum = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(6) > div.rating.clickArea > a > em").text
rate = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(6) > div.rating.clickArea > span.score > em").text
address = driver.find_element_by_css_selector(
    "#info\.search\.place\.list > li:nth-child(6) > div.info_item > div.addr > p:nth-child(1)").text
